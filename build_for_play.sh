...
cp -rv android/app/build/outputs/bundle/flavor1Release/* outputs/bundle/

for filename in outputs/bundle/app-store*.aab; do
...
for filename in outputs/bundle/app-flavor1*.aab; do
  java -jar signer/apksigner.jar sign --v1-signing-enabled --v2-signing-enabled --v3-signing-enabled=false \
